...
const GestionFormularioReducer = () => {
    ...
    return(<>
        ...
        <form action="submit">
            <label>Nombre </label>
            <input data="nombre" type="text" onChange={(e) => {cambiaValor(e.target.value); validaForm("nombre", state);}}/>{state.flag && state.data === "nombre" ? null : <> Debe contener entre 8 y 20 caracteres...</>}<br/><br/>
